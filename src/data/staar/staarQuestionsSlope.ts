...
export const STAAR_SLOPE_QUESTIONS: StaarPracticeQuestion[] = [
  ...
  },
  {
    ...
    standardType: 'Readiness',
    reportingCategory: 2,
    subtopic: 'Undefined Slope of a Vertical Line on a Coordinate Grid',
    question:
      'The graph shows a vertical line on a coordinate grid passing through points (-4, -2) and (-4, 4). What is the slope of this line?',
    graphData: {
      title: 'Vertical Line on Coordinate Grid',
      xLabel: 'x',
      yLabel: 'y',
      xMin: -8,
      xMax: 6,
  ...
  },
  {
    ...
    standardType: 'Readiness',
    reportingCategory: 2,
    subtopic: 'Writing a Linear Equation from a Real-World Cost Graph',
    question:
      'The graph shows the total cost, y, in dollars to rent a power washer for x hours. Which linear equation best models this relationship?',
    graphData: {
      title: 'Equipment Rental Cost',
      xLabel: 'Hours Rented (x)',
  ...
  },
  {
    ...
    standardType: 'Readiness',
    reportingCategory: 2,
    subtopic: 'Writing Equation from Graph with Fractional Slope',
    question:
      'The graph displays a linear relationship between x and y. Which equation best represents the line shown?',
    graphData: {
      title: 'Linear Graph with Fractional Slope',
      xLabel: 'x',
      yLabel: 'y',
      xMin: 0,
      xMax: 8,
